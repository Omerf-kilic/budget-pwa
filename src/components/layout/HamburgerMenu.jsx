 ...
 * Covers the full viewport height and overlays the main content.
 *
 * @param {object} props
 ...
 * @param {function} props.onNavigate - Callback(pageKey) to switch pages
 */
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-5 border-b border-white/5">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-bold text-white leading-none">Budget</p>
        ...
        <div className="px-6 py-5 border-t border-white/5">
          <p className="text-xs text-slate-600 text-center">
            Budget Tracker v1.0 · All data stored locally
          </p>
        </div>
      </nav>
    </>
