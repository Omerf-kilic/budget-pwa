 ...
 * Each entry shows type badge, description, currency amount, and date.
 * Supports swipe-to-delete via a delete button (long press accessible).
 */
export default function History() {
  ...
  /**
   * Handles tapping delete: first tap shows confirmation,
   * second tap actually deletes (prevents accidental deletion).
   */
  ...
  return (
    <div className="scroll-area no-scrollbar h-full px-4 py-4 page-enter">
        ...
        <div className="flex flex-col items-center justify-center gap-4 mt-16 text-center">
          ...
          <div>
            ...
            <p className="text-slate-600 text-xs mt-1">
              Add an expense from the Dashboard to get started.
            </p>
          </div>
        </div>
      )}
      ...
      {/* ── Transaction list ─────────────────────────────── */}
      {transactions.length > 0 && (
        <ul className="space-y-2.5" role="list" aria-label="Transaction history">
          {transactions.map((tx) => {
            ...
            return (
              ...
              >
                ...
                <button
                  ...
                  `}
                  aria-label={isConfirming ? 'Confirm delete' : `Delete transaction: ${tx.description}`}
